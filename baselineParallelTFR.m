...
runcfg.dataAnalysisType         = 'MEG'; %Behavior or MEG 
...
elseif strcmp(runcfg.dataAnalysisType,'MEG')
    ...
    for ipart = 1:length(runcfg.partlist)
        ...
        outputfile{ipart}.path   = sprintf ('/mnt/homes/home024/chrisgahn/Documents/MATLAB/freq/trialsLowFreq/baselinedStim/%s.mat'...
