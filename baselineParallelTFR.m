...
runcfg.partlist = {
    ...
    % 'MTo/20150825'
    % 'DLa/20150826'
     'BPe/20150826'            %Super slow when running analysis.
    % 'ROr/20150827'
    % 'HEn/20150828'
    % 'MSo/20150820'
    % 'NSh/20150825'
    ...
    % 'LMe/20150826'
%    'MAb/20150816'               %Should be ignored for all analyses ideally.
...
if strcmp(runcfg.dataAnalysisType,'behavior')
    ...
    for ipart = 1:length(runcfg.partlist)
        ...
        cfg1{ipart}.sim_task     = 0;
        %Ignores the maximum likelihood estimation if 1.
        %Yes if recover, and simulate. No if recover and param fit.
        cfg1{ipart}.modelchoices = 0;
        cfg1{ipart}.test         = 0;%Deceide to run one cfg or more.
        cfg1{ipart}.recover      = 1; %Recover parameter fits of already simulated sessions.
...
elseif strcmp(runcfg.dataAnalysisType,'parameterOptimize')
    ...
    for ipart = 1:length(runcfg.partlist)
        ...
        %what does simulate do? Simalate model choices.
        cfg1{ipart}.simulate     = 0;
        cfg1{ipart}.modelchoices = 1; %Ignores the maximum likelihood estimation if 1.
        cfg1{ipart}.recover      = 1;
