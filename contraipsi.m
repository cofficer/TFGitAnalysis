...
BPallCue  = NaN(33,21,16,2); %low prob choice
BPallStim = NaN(33,21,16,2); %medium prob choice
BPallResp = NaN(33,31,16,2); %high prob choice
...
save('timecourseCuelowLS.mat','BPallCue')
save('timecourseStimlowLS.mat','BPallStim')
save('timecourseResplowLS.mat','BPallResp')
